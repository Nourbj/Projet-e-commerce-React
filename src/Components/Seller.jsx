...
import img4 from '../assets/img/product-thumb-4.jpg'
        ...
        <div class="row">
            ...
            <div class="single-product-widget">
              ...
              <div class="single-wid-product">
                <a href="single-product.html">
                  <img src={img1} alt class="product-thumb" />
                </a>
                <h2>
              ...
              <div class="single-wid-product">
                <a href="single-product.html">
                  <img src={img2} alt class="product-thumb" />
                </a>
                <h2>
              ...
              <div class="single-wid-product">
                <a href="single-product.html">
                  <img src={img3} alt class="product-thumb" />
                </a>
                <h2>
          ...
          <div class="col-md-4">
            <div class="single-product-widget">
              ...
              <div class="single-wid-product">
                <a href="single-product.html">
                  <img src={img4} alt class="product-thumb" />
                </a>
                <h2>
