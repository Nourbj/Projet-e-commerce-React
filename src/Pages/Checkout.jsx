                      ...
                      <div className="col-6">
                        <div className="woocommerce-shipping-fields">
                          ...
                          <p className="form-row form-row-wide address-field update_totals_on_change validate-required" id="shipping_country_field">
                            ...
                            <select
                              {...register("shipping_country", { required: "Civility is required" })}
                              id="shipping_country"
                            ...
                            {errors.shipping_country && <span className="error">{errors.shipping_country.message}</span>}
                          </p>
                          ...
                          <p className="form-row form-row-first validate-required" id="shipping_first_name_field">
                            ...
                            <input
                              ...
                              type="text"
                            />
                            {errors.shipping_first_name && <span className="error">{errors.shipping_first_name.message}</span>}
                          </p>
                          ...
                          <p className="form-row form-row-last validate-required" id="shipping_last_name_field">
                            ...
                            <input
                              ...
                              type="text"
                            />
                            {errors.shipping_last_name && <span className="error">{errors.shipping_last_name.message}</span>}
                          </p>
                          ...
                          <p className="form-row form-row-wide address-field validate-required" id="shipping_address_1_field">
                            ...
                            <input
                              {...register("shipping_address_1", { required: "Address is required" })}
                              id="shipping_address_1"
                              type="text"
                            />
                            {errors.shipping_address_1 && <span className="error">{errors.shipping_address_1.message}</span>}
                          </p>
                          ...
                          <p className="form-row form-row-wide address-field validate-required" id="shipping_city_field">
                            ...
                            <input
                              ...
                              type="text"
                            />
                            {errors.shipping_city && <span className="error">{errors.shipping_city.message}</span>}
                          </p>
                          ...
                          <p className="form-row form-row-first address-field validate-required" id="shipping_postcode_field">
                            ...
                            <input
                              {...register("shipping_postcode", { required: "Postcode is required" })}
                              id="shipping_postcode"
                              type="text"
                            />
                            {errors.shipping_postcode && <span className="error">{errors.shipping_postcode.message}</span>}
                          </p>
